...
class Trainer_np_Array():
	...
	def Train(self,TrainingDataPoints,TrainingLabels,BatchSize):
	...
	def get_HiddenLayer1Dict(self):
		return self.HiddenLayer1Dict

	def get_OutputLayerDict(self):
		return self.OutputLayerDict		
